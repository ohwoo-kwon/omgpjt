...
<style scoped>
  #bg {
    position: absolute;
    background: url('../assets/Concept.jpg');
  ...
  #album-info {
    ...
    animation: album-info 1s 0.4s forwards;
    opacity: 0;
  }

  @keyframes album-info {
    0% { opacity: 0;}
    100% { opacity: 1; right: 5rem;}
  }
